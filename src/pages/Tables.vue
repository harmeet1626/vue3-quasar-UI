<template>
    <div class="q-pa-md">
        <q-table class="my-sticky-header-table" flat bordered title="Treats" :rows="rows" :columns="columns"
            row-key="name" />
    </div>
    <hr>
    <div class="q-pa-md">
        ...
        <q-table flat bordered title="Treats" :rows="rows" :columns="columns" row-key="name" :separator="separator" />
    </div>
    <hr>
    <div class="q-pa-md">
    ...
    <hr>
    <div class="q-pa-md">
        <q-table grid flat bordered card-class="bg-primary text-white" title="Treats" :rows="rows" :columns="columns"
